...
class NeumorphShapeAppearanceModel {
    ...
    class Builder {
        ...
        private fun setAllCorners(@CornerFamily cornerFamily: Int): Builder {
            return apply {
                this.cornerFamily = cornerFamily
            }
        }

        private fun setAllCornerSizes(cornerSize: Float): Builder {
            return apply {
    ...
    companion object {
        ...
        private fun getCornerSize(a: TypedArray, index: Int, defaultValue: Float): Float {
